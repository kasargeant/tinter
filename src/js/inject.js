/**
 * @file Inject.js
 * @description A version of Tinter that directly extends the build-in string.  A lean and fast console string colorizing module - supports CSS naming and up to 16M+ colors.
...
for(let idx = 0; idx < styles.length; idx++) {
    let key = styles[idx];
    Object.defineProperty(String.prototype, key, {configurable: true, get: function() {
        return `\x1b[${idx}m${this}\x1b[0m`;
    }});
}
for(let idx = 0; idx < colors.length; idx++) {
    ...
    if(config.scheme === "16") {
        let degrade = color[3];
        Object.defineProperty(String.prototype, key, {configurable: true, get: function() {
            return `\x1b[1m\x1b[${degrade}m${this}\x1b[0m`;
        }});
        Object.defineProperty(String.prototype, key + "Bg", {configurable: true, get: function() {
            return `\x1b[1m\x1b[${degrade + 10}m${this}\x1b[0m`;
        }});
    } else if(config.scheme === "256") {
        let degrade = color[2];
        Object.defineProperty(String.prototype, key, {configurable: true, get: function() {
            return `\x1b[1m\x1b[38;5;${degrade}m${this}\x1b[0m`;
        }});
        Object.defineProperty(String.prototype, key + "Bg", {configurable: true, get: function() {
            return `\x1b[1m\x1b[48;5;${degrade}m${this}\x1b[0m`;
        }});
    } else if(config.scheme === "16M") {
        Object.defineProperty(String.prototype, key, {configurable: true, get: function() {
            return `\x1b[1m\x1b[38;2;${r};${g};${b}m${this}\x1b[0m`;
        }});
        Object.defineProperty(String.prototype, key + "Bg", {configurable: true, get: function() {
